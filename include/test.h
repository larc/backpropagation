...
#define PRINT_HEADER printf("| %12s | %24s | %12s | %12s | %12s | %12s | %12s | %16s |\n", "dataset", "train_type", "train_time", "n_iter", "h_layers", "train_error", "test_error", "h_units"); \
					 printf("| -----------: | -----------------------: | -----------: | -----------: | -----------: | -----------: | -----------: | ---------------: |\n");
#define PRINT_RESULT printf("| %12s | %24s | %12.3lf | %12ld | %12ld | %12.3lf | %12.3lf | %16s |\n", dataset, train_type, train_time, n_iter, h_layers, train_error * 100, test_error * 100, h_units.c_str());


#define data_path(file) (std::string(SRC_PATH) + "/data/" + file)
